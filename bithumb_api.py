"""
bithumb_api.py
빗썸 REST API 래퍼 — V5.1.0
Secret Base64 디코딩 적용 (Invalid Apikey 해결)
"""
...
print(f"[bithumb_api.py] V{VERSION} 로드됨 (Base64 디코딩)")
...
class BithumbAPI:
    ...
    def __init__(self):
        ...
        # ⭐ Secret을 Base64 디코딩 (핵심!)
        self.secret_key = base64.b64decode(secret_b64)
